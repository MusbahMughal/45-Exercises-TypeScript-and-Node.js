...
var person = "misbah";
console.log("hello, ".concat(person, " Would like to  learn Typescript Today"));
// Q-2 Name Cases: Store a person’s name in a variable, and then print that person’s 
// name in lowercase, uppercase, and titlecase.
// lowercase,
var person_2 = " I am checking type case ";
...
var famous_qoute = '"A person who never made a mistake never tried anything new."';
var message = "".concat(famous_person, " Once said ,").concat(famous_qoute);
console.log(message);
...
var favNum = 6;
console.log("My fav number is ".concat(favNum));
// Question-9Favorite Number: Store your favorite number in a variable. Then, using that variable, create a message that reveals your favorite number. Print that message.
// addition, subtraction,   multiplication, and division operations
console.log(6 + 14);
console.log(30 - 10);
console.log(4 * 5);
console.log(40 / 2);
// Question-10Adding Comments: Choose two of the programs you’ve written, and add at least one comment to each. If you don’t have anything specific to write 
...
var customer = ["misbah", "kinza", "komal"];
